...
CI then starts both production builds and requests their HTML, Tileflow manifest, and Madrid style;
the Next demo is checked through both its static output and its route handler.
